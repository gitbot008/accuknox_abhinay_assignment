...
from .views import  FriendRequestCreateAPIView,RejectFriendRequestAPIView,AcceptFriendRequestAPIView ,FriendRequestListCreateAPIView, LoginView, RecievedRequestAcceptedListAPIView, RecivedRequestPendingListAPIView, SentRequestAcceptedListAPIView, SentRequestPendingListAPIView, SignUpView, UserSearchAPIView, UserkapDetailAPIView, UserkapListCreateAPIView
